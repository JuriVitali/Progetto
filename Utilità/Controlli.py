class Controlli():
    ...
    # ritorna True se il codice per la tessera è valido , cioè se la sua lunghezza è 10,
    # contiene solo cifre e nessun altro cliente ne possiede una con lo stesso codice
    @staticmethod
